...
import { ImageFormat, AnyRequestData, RawRequest, RequireAllOptions, CommandUser, InteractionRequestData } from './constants';
...
declare class SlashCreator extends SlashCreator_base {
     ...
     * @private
     */
    _awaitingCommandCtxs: Map<string, CommandContext>;
