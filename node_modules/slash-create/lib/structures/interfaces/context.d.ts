...
declare class CommandContext extends MessageInteractionContext {
     ...
     */
    registerComponent(custom_id: string, callback: ComponentRegisterCallback): void;
    /**
     * Unregisters a component callback.
     * @param custom_id The custom ID of the component to unregister
     */
    unregisterComponent(custom_id: string): boolean;
    /** @hidden */
    _onComponent(ctx: ComponentContext): void;
    /** @private */
